...
export default function BookmarkCard({ bookmark, onDelete, onEdit }: BookmarkCardProps) {
  ...
  return (
    <div className="group bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-xl dark:hover:shadow-2xl transition-all duration-200 overflow-hidden hover:-translate-y-1">
      {/* Thumbnail */}
      <a
        href={bookmark.url}
        target="_blank"
